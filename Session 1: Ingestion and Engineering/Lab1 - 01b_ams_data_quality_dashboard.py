...
----------------------------------------------------------------------------------
This Streamlit application provides real-time monitoring of data quality metrics
from Snowflake's Data Quality Monitoring framework. It displays visualizations
for null counts, duplicate counts, format validation results, and other quality
indicators with interactive charts and alert thresholds.

Key Concepts:
  • Snowpark Integration: Direct connection to Snowflake for data retrieval
  • Data Quality Monitoring: Real-time tracking of data quality metrics
  • Interactive Dashboards: Streamlit-based visualization and filtering
  • Alert System: Configurable thresholds for data quality issues
  • Real-time Updates: Dynamic refresh of quality metrics and charts
----------------------------------------------------------------------------------
"""
