...
Demo:         AMS Labs ML Attrition Analytics Dashboard
Create Date:  2025-06-15
Purpose:      Interactive Streamlit dashboard for HR employee attrition analysis and ML model insights
Data Source:  HR_ANALYTICS.ML_MODELING.HR_EMPLOYEE_ATTRITION
Customer:     Human Resources Analytics and Predictive Modeling
***************************************************************************************************

----------------------------------------------------------------------------------
This comprehensive Streamlit application provides interactive analytics and machine
learning insights for HR employee attrition analysis. It features data exploration,
statistical analysis, predictive modeling capabilities, and model inference using
Snowflake's ML Registry for real-time attrition risk assessment.

Key Concepts:
  • ML Model Registry: Integration with Snowflake's model registry for inference
  • Interactive Analytics: Dynamic data exploration and visualization
  • Predictive Modeling: Real-time attrition risk prediction and analysis
  • Statistical Analysis: Comprehensive HR metrics and trend analysis
  • Data Visualization: Advanced charts and dashboards using Plotly and Seaborn
----------------------------------------------------------------------------------
"""
